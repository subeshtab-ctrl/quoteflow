...
class QuoteFlowStore {
  ...
  private seedInitialData() {
    ...
    const demoOrg: Organization = {
      id: DEFAULT_ORG_ID,
      name: 'Apex Technologies India',
      slug: 'apex-tech',
      business_type: 'IT Services & Software',
      email: 'contact@apextechnologies.io',
      phone: '+91 98765 43210',
      website: 'https://apextechnologies.io',
      gst_vat_number: '29ABCDE1234F1Z5',
      address_line1: 'Tower B, 4th Floor, Tech Park, Indiranagar',
      city: 'Bengaluru',
      state: 'Karnataka',
      country: 'India',
      postal_code: '560038',
      ...
      invoice_footer: 'Thank you for choosing Apex Technologies!',
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString(),
    };
